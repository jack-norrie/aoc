...
def solve(vertices, edges: list[tuple[float, int, int]], n_connections: int) -> int:
    heapq.heapify(edges)
    ...
    logging.debug(component_sizes)

    res = reduce(mul, sorted(component_sizes.values())[-3:])
